...
import PortalFreeServices from "./PortalFreeServices";

type Props = { params: Promise<{ slug: string }> };

export default async function ResellerFreeServicesPage({ params }: Props) {
  ...
  return <PortalFreeServices slug={slug} />;
}
