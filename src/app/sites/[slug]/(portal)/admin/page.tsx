...
import ResellerAdminPage from "./ResellerAdmin";

type Props = { params: Promise<{ slug: string }> };

export default async function ResellerAdminDashboardPage({ params }: Props) {
  ...
  return <ResellerAdminPage slug={slug} siteName={siteName} />;
}