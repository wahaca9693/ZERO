...
export default async function audit-logPage({ params }: Props) {
  ...
  void siteName;
  return <ResellerAdminModule slug={slug} title="سجل التدقيق" description="مراجعة الأحداث الإدارية" endpoint="/admin/audit-log" icon="audit" />;
}
