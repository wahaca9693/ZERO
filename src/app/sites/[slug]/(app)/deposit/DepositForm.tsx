...
const methods = [
  { 
    id: "asiacell", 
    name: "آسياسيل", 
    icon: () => <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M17 18c-1.1 0-2-.9-2-2V10c0-1.1.9-2 2-2s2 .9 2 2v6c0 1.1-.9 2-2 2zm-10 0c-1.1 0-2-.9-2-2V10c0-1.1.9-2 2-2s2 .9 2 2v6c0 1.1-.9 2-2 2zm14-14H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H3V6h18v14z"/></svg>,
    name: "آسياسيل", 
      ...
      <div className="rounded-2xl bg-gradient-to-br from-[var(--site-primary)]/20 to-[var(--site-secondary)]/20 border border-[var(--site-primary)]/30 p-6">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            ...
            <p className="mt-1 text-zinc-400">رصيدك الحالي: <span className="font-black text-emerald-400">{balance.toFixed(2)} $</span></p>
          </div>
        </div>
      </div>
