            ...
            <div className="rounded-xl border border-white/10 bg-white/5 p-5">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input type="text" defaultValue={(await import("next/navigation")).useParams().then(p => (await p).slug)} className="mt-1 w-full rounded-xl border border-white/10 bg-white/5 px-4 py-2 text-white outline-none focus:border-[var(--site-primary)]" readOnly />
                </div>
              </div>
            </div>
            <div className="rounded-xl border border-white/10 bg-white/5 p-5">
