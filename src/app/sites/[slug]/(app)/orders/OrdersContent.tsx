...
import { Search, Filter, Package, Clock, CheckCircle2, AlertCircle, Truck, Package as PackageIcon, MoreVertical, ExternalLink } from "lucide-react";
...
export default function OrdersPage({ slug, siteName, primary, secondary, expired }: Props) {
    ...
    <div className="space-y-6" style={{ "--site-primary": primary, "--site-secondary": secondary } as React.CSSProperties}>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <input type="text" placeholder="بحث..." className="w-64 pl-10 pr-4 py-2 rounded-xl border border-white/10 bg-white/5 text-white outline-none focus:border-[var(--site-primary)]" value={search} onChange={e => setSearch(e.target.value)} />
        </div>
      </div>
