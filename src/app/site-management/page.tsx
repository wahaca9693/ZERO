...
type Site = { id: number; slug: string; displayName: string; status: string; subscriptionStatus: string; subscriptionPrice: number; subscriptionCurrency: string; nextBillingAt: string | null; publicUrl: string; theme: { primaryColor?: string; secondaryColor?: string }; paymentMethods: PaymentMethod[]; providerAccessEnabled: boolean; customers: number };
